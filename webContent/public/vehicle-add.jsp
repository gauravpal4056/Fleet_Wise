            ...
            <li class="nav-item">
                ...
                <div  id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="consignment-view_3.jsp">View All Consignment</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">                        
                        ...
                        <a class="collapse-item" href="route-delete.jsp">Delete Route</a>
                    </div>
                </div>
            </li>
                        ...
                        <div class="col-lg-6 mb-4 custom-div-c">
                            <div class="vehicle-form-con">
                                <div class="body-form vehicle-form">
                              		<h4 style="margin-bottom:20px;" class="m-9 font-weight-bold ">Add Vehicle</h4	>
                                    <form id="vehicleForm oc" method="post" action="../VehicleServlet">
                                       <div class="form-flex">
                                        <div class="form-group">
                                            <label for="hubName" class="lp">Registration Number</label>
                                            <input type="text" minlength="10" id="hub_name" name="registrationNumber" required placeholder="GJ 00 XY 0000 " >
                                          </div>
                                          <div class="form-group">
											<label for="route" class="lp">Select Driver</label>
		                                    <select class="" id="route" name="driver" required>
		                                    	<option value="" disabled selected hidden>No driver selected</option>
		                                        <% 
		                                        ...
		                                        try {
		                                            ...
		                                            List<Driver> drivers = dDao.findAllAvailable(); // Assuming there's a method findAllRoutes() in your DAO
		                                            if(drivers != null){for (Driver d : drivers) {
		                                    %>
		                                        <option value="<%= d.getDriverId() %>"><%= d.getName() %></option>
		                                    <%
		                                            }}
                                       ...
                                       <div class="form-flex">
                                        <div class="form-group">
                                            <label for="address" class="lp">Model</label>
                                            <input type="text" id="address" name="model" required placeholder="Vehicel Model">
                                          </div>
                                          <div class="form-group">
                                            <label for="fuelType" class="lp">Fuel Type</label>
                                            <select id="fuelType" name="fuelType" required>
                                     			<option value="" disabled selected hidden>No Fuel selected</option>
                                       ...
                                       <div class="form-flex">
                                        <div class="form-group">
                                            <label for="city" class="lp">Is Maintained ? </label>
											<select id="fuelType" name="due" required>
                                     			<option value="" disabled selected hidden>YES or No</option>
	                                              <option value="False">True</option>
	                                              <option value="True">False</option>
                                            </select>                                          </div>
                                          <div class="form-group">
                                            <label for="lastMaintenanceDate" class="lp">Requires Maintenance in</label>
                                            <input type="number" id="contact_number" name="thresoldmonth" required placeholder="in(months) ">
                                          </div>
                                       </div>
                                       <div class="form-flex">
                                        <div class="form-group">  
                                            <label for="city" class="lp">Last Maintenance Date</label>
                                            <input type="date" id="email_address" name="lastMaintenanceDate" required placeholder="E-mail">
                                          </div>
                                       </div>
                                        <button type="submit" class="bbp">Add Vehicle</button>
                                      </form>
                                   </div>
                               </div>  
