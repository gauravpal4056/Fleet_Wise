                        ...
                        <div class="col-lg-6 mb-4 custom-div-c">
                            <div class="vehicle-form-con">
                                <div class="body-form vehicle-form">
                              		<h4 style="margin-bottom:20px;" class="m-9 font-weight-bold ">Create Hub</h4	>
                                    <form id="vehicleForm oc" method="post" action="../HubServlet">
                                       <div class="form-flex">
                                        <div class="form-group">
                                            <label for="hubName" class="lp">Hub Name</label>
                                            <input type="text" id="hub_name" name="hub_name" required placeholder="Hub Name " >
                                          </div>
                                          <div class="form-group">
											<label for="route" class="lp">Select route</label>
		                                    <select class="" id="route" name="route_id" required>
                                       ...
                                       <div class="form-flex">
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <label for="pincode" class="lp">Pincode</label>
											<input type="number" id="pincode" name="pincode" required placeholder="- - - - - -">
                                          </div>
                                       </div>
                                       <div class="form-flex">
                                        <div class="form-group">
                                            <label for="city" class="lp">City </label>
                                            <input type="text" id="city" name="city" required placeholder="city">
                                          </div>
                                          <div class="form-group">
                                            <label for="lastMaintenanceDate" class="lp">Contact number	</label>
                                            <input type="number" id="contact_number" name="contact_number" required placeholder="+91 ">
                                          </div>
                                       </div>
                                       <div class="form-flex">
                                        <div class="form-group">
                                            <label for="city" class="lp">E-mail Address </label>
                                            <input type="email" id="email_address" name="email_address" required placeholder="E-mail">
                                          </div>
                                       </div>
                                        <button type="submit" class="bbp">Create Hub</button>
                                      </form>
                                   </div>
                               </div>  
