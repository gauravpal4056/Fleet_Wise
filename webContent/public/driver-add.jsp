                        ...
                        <div class="col-lg-6 mb-4 custom-div-c">
                            <div class="vehicle-form-con">
                                <div class="body-form vehicle-form">
                              		<h4 style="margin-bottom:20px;" class="m-9 font-weight-bold ">Add Driver</h4	>
                                     ...
                                     <div class="form-flex">
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="number" minlength="2" id="driverAge" name="driverAge" required placeholder="Age" min="18" max="100">
                                          </div>
                                     </div>
                                     ...
                                     <div class="form-flex">
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="number" minlength="10" id="driverPhone" name="driverPhone" required placeholder="Phone number" pattern="[0-9]{10}">
                                          </div>
                                     </div>
                                     <div class="form-flex">
                                        <div class="form-group">
                                            <label for="licenceNumber" class="lp">License Number</label>
                                            <input type="text" maxlength="15" minlength="15" id="licenceNumber" name="licenceNumber" required placeholder="License number">
                                          </div>
                                          <div class="form-group">
