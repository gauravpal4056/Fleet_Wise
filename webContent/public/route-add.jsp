            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="vehicle-remove.jsp">Remove Vehicle</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                         <img class="img-fluid px-1 px-sm-1 mt-1 mb-1" style="width: 15rem;" src="img/route.jpg" alt="...">
                     </div>
                         ...
                         <div class="vehicle-form-con">
                             <div class="body-form vehicle-form">
                                 ...
                                 <form id="routesForm" action="../RouteServlet" method="post">
                     				<h4 style="margin-bottom:20px;" class="m-9 font-weight-bold ">CREATE ROUTE</h4	>
                                     <div class="form-flex">
